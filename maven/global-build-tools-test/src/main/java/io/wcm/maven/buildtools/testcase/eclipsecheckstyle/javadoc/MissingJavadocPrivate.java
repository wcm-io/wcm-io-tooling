 ...
 * Expected warnings: 0
 */
class MissingJavadocPrivate<T> implements Comparable<T> {
   ...
   */
  void methodParameter(int param) {
    // no warning
  }
   ...
   * @return Object
   */
  <T2 extends Object> T2 methodTypeParameter() {
    // no warning
    return null;
  }
